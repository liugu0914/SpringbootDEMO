...
public class Datasource {
    ...
    public SqlSessionFactory sqlSessionFactory( DataSource dataSource)
            throws Exception {
//        String driverClassPath = this.config.getProperty("eman.pagings", "master.driverClassName"); // 指定分页驱动类型Key
//        String driverClassName = this.config.getProperty(driverClassPath);
